...
import com.ahmedapps.mystatusdownloader.Adapter.FacnyTextAdapter
import com.ahmedapps.mystatusdownloader.R
import com.ahmedapps.mystatusdownloader.databinding.ActivityFancyTextBinding
import com.ahmedapps.mystatusdownloader.utils.styles

class FancyTextActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.text.text = getString(R.string.fancy_text)
        binding.textInfo.text = getString(R.string.fancy_text_info)
    ...
    private fun buildRecycleView() {
        ...
        binding.editText.setText("Hi There")

       val adapter = FacnyTextAdapter(this, styles)
